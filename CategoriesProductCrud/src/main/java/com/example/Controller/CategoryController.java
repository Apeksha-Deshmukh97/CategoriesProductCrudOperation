...
public class CategoryController {
		...
		private CategoryService categoryService;
		 ...
		 // This method is used to get all the categories detail
		...
		// This method used to store the categories details
		...
		public ResponseEntity<Category> getCategoryById(@PathVariable("id") Integer id) throws Exception {
		...
		public ResponseEntity<Category> updateCategoryById(@PathVariable("id") Integer id, @RequestBody Category category) throws Exception {
